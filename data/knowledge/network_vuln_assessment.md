...
Use SecuraIQ **Vuln Assessment** mode with a **Target IP** on networks you own or have written permission to test (home lab, HTB/THM VPN, VulnHub, company engagement scope).
...
## What SecuraIQ probes
1. Common TCP ports (FTP/SSH/HTTP/SMB/RDP/DB/…)
2. Light banners + HTTP/TLS fingerprints
3. Optional `nmap` top-ports if installed on the host running SecuraIQ
