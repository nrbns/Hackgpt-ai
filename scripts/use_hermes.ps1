...
foreach ($pair in @(
    ...
    @{k='HERMES_SESSION_KEY';v='hackgpt-pentest'},
...
$content = $content -replace "(?m)^HERMES_SESSION_KEY=.*", "HERMES_SESSION_KEY=hackgpt-pentest"
...
Write-Host ""
Write-Host "Configured HackGPT for full Hermes Agent integration."
