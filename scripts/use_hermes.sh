#!/usr/bin/env bash
# Full Hermes Agent backend for SecuraIQ (Linux/macOS/WSL)
set -euo pipefail
cd "$(dirname "$0")/.."
. scripts/common.sh
...
set_env_value HERMES_SESSION_KEY securaiq-pentest
...
echo ""
echo "Configured SecuraIQ for full Hermes Agent integration."
